using AutoMapper;
using Gis.Net.Core.Controllers;
...
namespace Gis.Net.Vector.Controllers;

public abstract class GisCoreBaseController<TDto, TModel, TQuery, TRequest, TContext> : 
    ...
    where TContext : DbContext
{
    ...
    /// <inheritdoc />
    protected GisCoreBaseController(ILogger logger,
